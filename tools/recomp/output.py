...
def generate_header(func_list, output_path, abi_db=None, target_name="Xbox target"):
    """
    Generate a C header with forward declarations for translated functions.
    Uses ABI data for proper signatures when available and labels the exact target.
    """
    abi_db = abi_db or {}

    lines = [
        "/**",
        f" * {target_name} - Recompiled Function Declarations",
